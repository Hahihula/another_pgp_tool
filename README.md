...
- App has "no memory". It does not store any data. Even switching tabs erases all form fields. (Right now it stores webview data in TEMP folder, will be fixed soon, but this should not be a concern for most users)
